...
// Tham chiếu giá trị của reviewsData
const { 
    name,             
    orderId, 
    image,            
        ...
        <div className="white-card">
          ...
          <div className="vm-product-row">
            <div className="vm-prod-left">
              ...
              <div className="vm-prod-info">
                ...
                <p className="vm-price">Thành tiền: {formatCurrency(price)} <sup>đ</sup></p>
              </div>
            </div>
          ...
          <div className="vm-user-row">
              <div className="vm-user-left">
                <img src={reviewerAvatar || "https://statictuoitre.mediacdn.vn/thumb_w/640/2017/7-1512755474943.jpg"} alt={reviewerName} className="vm-avatar" />
